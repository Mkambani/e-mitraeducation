...
const BannerFormModal: React.FC<{
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex justify-center items-center z-50 p-4 animate-fade-in">
            <div className="bg-admin-card-bg border-admin-card-border rounded-xl shadow-2xl w-full max-w-lg mt-16">
                <form onSubmit={handleSubmit}>
                    <div className="p-6 border-b border-admin-card-border">
                        <h2 className="text-xl font-bold text-admin-heading">{slide ? 'Edit' : 'Add'} Banner Slide</h2>
                    </div>
                    <div className="p-6 space-y-4">
                        <input type="text" placeholder="Title" value={formState.title} onChange={e => handleChange('title', e.target.value)} required className="w-full p-3 bg-admin-main-bg text-admin-heading border border-admin-card-border rounded-lg focus:ring-2 focus:ring-admin-accent focus:border-admin-accent transition" />
                        <input type="text" placeholder="Subtitle" value={formState.subtitle} onChange={e => handleChange('subtitle', e.target.value)} required className="w-full p-3 bg-admin-main-bg text-admin-heading border border-admin-card-border rounded-lg focus:ring-2 focus:ring-admin-accent focus:border-admin-accent transition" />
                        <input type="text" placeholder="Code / Call to Action" value={formState.code} onChange={e => handleChange('code', e.target.value)} required className="w-full p-3 bg-admin-main-bg text-admin-heading border border-admin-card-border rounded-lg focus:ring-2 focus:ring-admin-accent focus:border-admin-accent transition" />
