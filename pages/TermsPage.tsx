  ...
  return (
    <div className="bg-white dark:bg-slate-800 p-8 sm:p-12 rounded-2xl shadow-xl border border-slate-200/50 dark:border-slate-700/50">
      <div className="prose dark:prose-invert max-w-none">
        ...
        <p>Welcome to Documentmitra. These terms and conditions outline the rules and regulations for the use of our website and services.</p>
        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Documentmitra if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p>Unless otherwise stated, Documentmitra and/or its licensors own the intellectual property rights for all material on our platform. All intellectual property rights are reserved. You may access this from Documentmitra for your own personal use subjected to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from Documentmitra</li>
          <li>Sell, rent or sub-license material from Documentmitra</li>
          <li>Reproduce, duplicate or copy material from Documentmitra</li>
          <li>Redistribute content from Documentmitra</li>
        </ul>
        ...
        <p>In no event shall Documentmitra, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
        ...
        <p>If you have any questions about these Terms, please contact us at <a href="mailto:legal@documentmitra.gov">legal@documentmitra.gov</a>.</p>
      </div>
    </div>
  );
};
