...
// Explicitly providing the fetch implementation can help resolve intermittent "TypeError: Failed to fetch" errors
// that can occur due to environment-specific issues or problems with how dependencies are bundled.
export const supabase = createClient<Database>(supabaseUrl, supabaseAnonKey, {
  global: {
    fetch: (...args: [input: RequestInfo | URL, init?: RequestInit]) => fetch(...args),
  },
});
