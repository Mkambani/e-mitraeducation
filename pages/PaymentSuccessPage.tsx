...
const PaymentSuccessPage: React.FC = () => {
  ...
  return (
    <div className="relative z-10 text-center flex flex-col items-center justify-center min-h-[60vh]">
       <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl p-8 sm:p-12 rounded-3xl shadow-2xl border border-slate-200/50 dark:border-slate-700/50 max-w-2xl mx-auto">
        ...
        <div className="mt-8 flex justify-center items-baseline gap-8">
            <div className="bg-slate-50 dark:bg-slate-700 border border-dashed border-slate-300 dark:border-slate-600 rounded-xl p-4 flex-1">
      ...
      <style>{`
        ...
        .dark body.payment-success-bg::before {
            background: radial-gradient(ellipse at top, #0e7490, transparent),
                        radial-gradient(ellipse at bottom, #1e293b, transparent);
        }
        ...
        .dark @keyframes fill {
          100% {
            box-shadow: inset 0px 0px 0px 60px #14532d;
          }
        }
      `}</style>
    </div>
